...
void   compute_pot_evap(int, const dmy_struct *, int, int, double, double , double, double, double, double **, double *);
...
void write_data(out_data_file_struct *, out_data_struct *, const dmy_struct *, int);

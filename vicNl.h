...
int snow_melt_glac(double latent_heat_Le, double NetShortSnow, double Tgrnd,
    ...
    double grnd_flux, double LongSnowIn, double pressure, double rainfall,
...
double solve_snow_glac(double BareAlbedo, double LongUnderOut, double Tgrnd,
    ...
    double snow_grnd_flux, double wind_h, double *AlbedoUnder,
    ...
    const float *root, int iveg, int band, int dt, int rec, int hidx,
